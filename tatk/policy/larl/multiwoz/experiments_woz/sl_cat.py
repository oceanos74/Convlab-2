...
from tatk.policy.larl.multiwoz.experiments_woz.dialog_utils import task_generate
import tatk.policy.larl.multiwoz.latent_dialog.domain as domain
from tatk.policy.larl.multiwoz.latent_dialog.main import train, validate
from tatk.policy.larl.multiwoz.latent_dialog.models_task import SysPerfectBD2Cat
from tatk.policy.larl.multiwoz.latent_dialog.evaluators import MultiWozEvaluator
from tatk.policy.larl.multiwoz.latent_dialog.data_loaders import BeliefDbDataLoaders
import tatk.policy.larl.multiwoz.latent_dialog.corpora as corpora
from tatk.policy.larl.multiwoz.latent_dialog.utils import Pack, prepare_dirs_loggers, set_seed
...
config = Pack(
    seed=10,
    train_path='/home/mawenchang/TATK/tatk/policy/larl/multiwoz/data/norm-multi-woz/train_dials.json',
    valid_path='/home/mawenchang/TATK/tatk/policy/larl/multiwoz/data/norm-multi-woz/val_dials.json',
    test_path='/home/mawenchang/TATK/tatk/policy/larl/multiwoz/data/norm-multi-woz/test_dials.json',
    max_vocab_size=1000,
    last_n_model=5,
    max_utt_len=50,
    max_dec_len=50,
